...
namespace Phantom
{
    public class UIResolution : MonoBehaviour
    {
        ...
        [SerializeField]
        private Camera resolutionCamera;
        [SerializeField]
        private Vector2 resolutionScreenSize = Vector2.zero;
        [SerializeField]
        private int resolutionFrameRate = 0;
        ...
        private void Awake()
        {
            if(resolutionCamera && resolutionScreenSize.x > 0 && resolutionScreenSize.y > 0)
            {
                ...
                Screen.SetResolution((int)resolutionScreenSize.x, (int)((screenSize.y / screenSize.x) * resolutionScreenSize.x), true);
            ...
            if(resolutionFrameRate > 0)
            {
                Application.targetFrameRate = resolutionFrameRate;
            }
        }
